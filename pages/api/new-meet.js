import { MongoClient, mongoClient } from 'mongodb'; //this is an object that allows us to connect
...
async function  handler(req, res) {
    ...
    const client = MongoClient.connect('mongodb+srv://janis-jenny:TwnmhwPfvdWcMQBO@cluster0.4jkrw.mongodb.net/meetups?retryWrites=true&w=majority'); //return promise
