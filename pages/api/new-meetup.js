...
async function  handler(req, res) {
    ...
    if (req.method === 'POST') { //allows to define what kind of request was sent
        ...
        // & insert or fetch data //this code will never ende up on the client side, this is a secure place to store credentials
        ...
        // result would be an object data w the automatic generated id
...
// then send a request to this api route from the front to trigger this handler
